...
public class UserType2PBL extends UserType2 {

	private Lock lock;
	private PropertyBasedLocker locker;

	public UserType2PBL(PropertyBasedLocker locker, Resource model, String vendor, String name) {
		super(model, vendor);
		this.locker = locker;
		this.lock = UtilityClass.buildLock(name,"lockOp2", buildBindings(), locker);
	}

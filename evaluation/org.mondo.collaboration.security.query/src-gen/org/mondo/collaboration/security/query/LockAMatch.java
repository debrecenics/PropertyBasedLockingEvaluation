...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.query.lockA pattern,
 * to be used in conjunction with {@link LockAMatcher}.
 * 
...
public abstract class LockAMatch extends BasePatternMatch {
  ...
  public List<String> parameterNames() {
    return LockAMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof LockAMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    LockAMatch other = (LockAMatch) obj;
  ...
  @Override
  public LockAQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static LockAMatch newEmptyMatch() {

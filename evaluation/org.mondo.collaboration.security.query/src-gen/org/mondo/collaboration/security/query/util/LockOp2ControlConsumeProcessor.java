...
/**
 * A match processor tailored for the org.mondo.collaboration.security.query.lockOp2ControlConsume pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class LockOp2ControlConsumeProcessor implements IMatchProcessor<LockOp2ControlConsumeMatch> {
  /**
  ...
  @Override
  public void process(final LockOp2ControlConsumeMatch match) {

...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.query.lockOp2ControlProvide pattern,
 * to be used in conjunction with {@link LockOp2ControlProvideMatcher}.
 * 
...
public abstract class LockOp2ControlProvideMatch extends BasePatternMatch {
  ...
  private LockOp2ControlProvideMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return LockOp2ControlProvideMatch.parameterNames;
  }
  ...
  @Override
  public LockOp2ControlProvideMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof LockOp2ControlProvideMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    LockOp2ControlProvideMatch other = (LockOp2ControlProvideMatch) obj;
  ...
  @Override
  public LockOp2ControlProvideQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static LockOp2ControlProvideMatch newEmptyMatch() {
   ...
   * 
   */
  public static LockOp2ControlProvideMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static LockOp2ControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends LockOp2ControlProvideMatch {
  ...
  private static final class Immutable extends LockOp2ControlProvideMatch {

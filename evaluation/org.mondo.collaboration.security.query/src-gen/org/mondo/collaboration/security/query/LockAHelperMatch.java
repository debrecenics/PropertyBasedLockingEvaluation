...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.security.query.lockAHelper pattern,
 * to be used in conjunction with {@link LockAHelperMatcher}.
 * 
...
public abstract class LockAHelperMatch extends BasePatternMatch {
  ...
  public List<String> parameterNames() {
    return LockAHelperMatch.parameterNames;
  }
  ...
  @Override
  public LockAHelperMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof LockAHelperMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    LockAHelperMatch other = (LockAHelperMatch) obj;
  ...
  @Override
  public LockAHelperQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static LockAHelperMatch newEmptyMatch() {

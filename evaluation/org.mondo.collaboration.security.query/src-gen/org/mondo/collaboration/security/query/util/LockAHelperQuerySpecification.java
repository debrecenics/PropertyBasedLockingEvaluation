...
public final class LockAHelperQuerySpecification extends BaseGeneratedEMFQuerySpecification<LockAHelperMatcher> {
  ...
  public LockAHelperMatch newMatch(final Object... parameters) {
    return LockAHelperMatch.newMatch((wt.Signal) parameters[0], (wt.Cycle) parameters[1], (java.lang.Integer) parameters[2], (wt.Control) parameters[3]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("signal", "wt.Signal"),new PParameter("cycle", "wt.Cycle"),new PParameter("value", "java.lang.Integer"),new PParameter("ctrl", "wt.Control"));
    }

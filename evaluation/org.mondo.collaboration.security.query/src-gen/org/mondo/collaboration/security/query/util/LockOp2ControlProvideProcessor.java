...
/**
 * A match processor tailored for the org.mondo.collaboration.security.query.lockOp2ControlProvide pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class LockOp2ControlProvideProcessor implements IMatchProcessor<LockOp2ControlProvideMatch> {
  /**
  ...
  @Override
  public void process(final LockOp2ControlProvideMatch match) {
